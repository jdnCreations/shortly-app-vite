const Navbar = () => {
  return (
    <nav className='grid grid-cols-mobile md:grid-cols-desktop items-center h-[40px] mt-[40px] justify-between'>
      <div className='col-start-2 flex justify-between items-center'>
        <div className='flex items-center gap-11'>
          ...
          <ul className='gap-6 hidden md:flex'>
            <li>
              <a
                href='#'
                className='text-dark-gray font-bold hover:text-darkest-gray text-[15px]'
              >
                Features
              </a>
            </li>
        ...
        <div className='md:flex hidden gap-6'>
          <button className='text-[15px] hover:text-darkest-gray text-dark-gray font-bold'>
            Login
          </button>
          <button className='text-[15px] font-bold text-[#FFF] bg-cyan px-6 rounded-full py-2 hover:bg-cyan/60'>
            Sign Up
          </button>
        </div>
        <div className='flex flex-col gap-[6px] md:hidden h-[21px] w-[24px] items-center'>
          <div className='bg-dark-gray w-full h-[3px]'></div>
          <div className='bg-dark-gray w-full h-[3px]'></div>
          <div className='bg-dark-gray w-full h-[3px]'></div>
        </div>
      </div>
